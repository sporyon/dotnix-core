    ...
    inputs.flake-parts.lib.mkFlake { inherit inputs; } rec {
      flake = {
        ...
        overlays.default = final: prev: {
          ...
          secure-boot.generate-secrets = final.callPackage ./pkgs/secure-boot/generate-secrets.nix {};
